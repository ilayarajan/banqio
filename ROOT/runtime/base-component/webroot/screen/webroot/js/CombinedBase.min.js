...
d===c.UP&&b.altKey?(a.close(),b.preventDefault()):d===c.ENTER?1>a.results.getHighlightedResults().length||a.options.get("ajaxResultsLoading")||(a.options.set("okToSelectOnClose",!0),a.close(),b.preventDefault(),a.options.set("okToSelectOnClose",!1),a.$element[0].focus()):d===c.SPACE&&b.ctrlKey?(a.trigger("results:toggle",{}),b.preventDefault()):d===c.UP?(a.trigger("results:previous",{}),b.preventDefault()):d===c.DOWN&&(a.trigger("results:next",{}),b.preventDefault());else if(d===c.ENTER||d===c.SPACE||
d===c.DOWN&&!b.ctrlKey)a.open(),b.preventDefault();else if(d>=c.ZERO&&d<=c.NINE||d>=c.NUMZERO&&d<=c.NUMSTAR||d>=c.NUMSUBTRACT&&d<=c.DIVIDE||d>=c.A&&d<=c.Z||d>=c.SEMICOLON&&d<=c.GRAVE||d>=c.OPENBRACKET&&d<=c.SINGLEQUOTE)a.open(),a.dropdown.$search.val(b.key),a.trigger("selection:update"),b.preventDefault()})};b.prototype._syncAttributes=function(){this.options.set("disabled",this.$element.prop("disabled"));this.options.get("disabled")?(this.isOpen()&&this.close(),this.trigger("disable",{})):this.trigger("enable",
{})};b.prototype._syncSubtree=function(a,b){var c=!1,d=this;if(!a||!a.target||"OPTION"===a.target.nodeName||"OPTGROUP"===a.target.nodeName){if(b)if(b.addedNodes&&0<b.addedNodes.length)for(var e=0;e<b.addedNodes.length;e++)b.addedNodes[e].selected&&(c=!0);else b.removedNodes&&0<b.removedNodes.length&&(c=!0);else c=!0;c&&this.dataAdapter.current(function(a){d.trigger("selection:update",{data:a})})}};b.prototype.trigger=function(a,c){var d=b.__super__.trigger,e={open:"opening",close:"closing",select:"selecting",
unselect:"unselecting"};void 0===c&&(c={});if(a in e){var f={prevented:!1,name:a,args:c};d.call(this,e[a],f);if(f.prevented){c.prevented=!0;return}}d.call(this,a,c)};b.prototype.toggleDropdown=function(){this.options.get("disabled")||(this.isOpen()?this.close():this.open())};b.prototype.open=function(){this.isOpen()||this.trigger("query",{})};b.prototype.close=function(){this.isOpen()&&this.trigger("close",{})};b.prototype.isOpen=function(){return this.$container.hasClass("select2-container--open")};
...
c,b){c||(c="stylesheet");b||(b="text/css");var d=!1;$("head link").each(function(c,b){-1!==b.href.indexOf(a)&&(d=!0)});if(!d){var e=document.createElement("link");e.href=a;e.rel=c;e.type=b;document.head.appendChild(e)}},retryInlineScript:function(a,c){try{eval(a)}catch(d){a=a.trim();var b=5>=c?c*c*100:-1;console.warn("inline script error "+c+" retry "+b+" script: "+a.slice(0,80)+"...");console.warn(d);5>=c&&setTimeout(moqui.retryInlineScript,b,a,c+1)}},format:function(a,c,b){c&&c.length&&(c=c.replace(/a/,
"A").replace(/d/,"D").replace(/y/,"Y"));if(b&&b.length){b=b.toLowerCase();if("date"===b)return c&&0!==c.length||(c="YYYY-MM-DD"),moment(a).format(c);if("time"===b)return c&&0!==c.length||(c="HH:mm:ss"),moment(a).format(c);if("timestamp"===b)return c&&0!==c.length||(c="YYYY-MM-DD HH:mm"),moment(a).format(c);if("bigdecimal"===b||"currency"===b)return a.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g,"$1,");if("long"===b||"integer"===b||"double"===b||"float"===b)return a.replace(/(\d)(?=(\d{3})+(?!\d))/g,
"$1,");console.warn("format type unknown: "+b)}if(moqui.isNumber(a))return a.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g,"$1,");b=moment(a);return b.isValid()?(c&&0!==c.length||(c="YYYY-MM-DD HH:mm"),b.format(c)):a},debounce:function(a,c){var b,d;return function(){var e=this,f=arguments;clearTimeout(b);b=setTimeout(function(){b=null;d=a.apply(e,f)},c);return d}},makeColumnsConsistent:function(a){a=$("#"+a+" table");var c=[],b,d,e,f;for(b=0;b<a.length;b++)if(d=a[b],d.rows&&0!==d.rows.length){f=0;
for(e=d.rows[f];5>f&&f<d.rows.length;)if((!e.cells||1>=e.cells.length)&&d.rows.length>f+1)f++,e=d.rows[f];else break;if(e.cells&&0!==e.cells.length)for(d=0;d<e.cells.length;d++){var g=$(e.cells[d]).width();if(!c[d]||c[d]<g)c[d]=g}}e=c.length;for(b=d=0;b<e;b++)d+=c[b];g=[];for(b=0;b<e;b++)g[b]=100*c[b]/d;for(b=0;b<a.length;b++)if(d=a[b],d.rows&&0!==d.rows.length){f=0;for(e=d.rows[f];5>f&&f<d.rows.length;)if((!e.cells||1>=e.cells.length)&&d.rows.length>f+1)f++,e=d.rows[f];else break;if(e.cells&&0!==
e.cells.length)for(d=0;d<e.cells.length;d++)e.cells[d].style.width=g[d]+"%"}},downloadData:function(a,c,b){a=new Blob([a],{type:b});if(window.navigator.msSaveOrOpenBlob)window.navigator.msSaveOrOpenBlob(a,c);else{var d=document.createElement("a"),e=URL.createObjectURL(a);d.href=e;d.download=c;document.body.appendChild(d);d.click();setTimeout(function(){document.body.removeChild(d);window.URL.revokeObjectURL(e)},0)}},notifyNotification:function(a,c){if(a){var b={};a.topic&&a.topic.length&&(b.tag=a.topic);
if(window.Notification&&"granted"===Notification.permission){var d=new Notification(a.title,b);a.link&&a.link.length&&(d.onclick=function(){window.open(a.link)});moqui.webrootVue&&moqui.webrootVue.addNotify(a.title,a.type)}else window.Notification&&"denied"!==Notification.permission?Notification.requestPermission(function(d){"granted"===d?(d=new Notification(a.title,b),a.link&&a.link.length&&(d.onclick=function(){window.open(a.link)}),moqui.webrootVue&&moqui.webrootVue.addNotify(a.title,a.type)):
c(a)}):c(a)}},NotifyOptions:function(a,c,b,d){this.message=moqui.htmlEncode(a);c&&(this.url=c);this.icon=d?d:"success"===b?"fa fa-check-circle":"warning"===b?"fa fa-exclamation-triangle":"danger"===b?"fa fa-exclamation-circle":"fa fa-info-circle"},NotifySettings:function(a){this.delay=4E3;this.offset={x:20,y:60};this.placement={from:"top",align:"right"};this.animate={enter:"animated fadeInDown",exit:""};this.type=a?a:"info";this.template='\x3cdiv data-notify\x3d"container" class\x3d"notify-container col-xs-11 col-sm-3 alert alert-{0}" role\x3d"alert"\x3e\x3cbutton type\x3d"button" aria-hidden\x3d"true" class\x3d"close" data-notify\x3d"dismiss"\x3e\x26times;\x3c/button\x3e\x3cspan data-notify\x3d"icon"\x3e\x3c/span\x3e \x3cspan data-notify\x3d"message"\x3e{2}\x3c/span\x3e\x3ca href\x3d"{3}" target\x3d"{4}" data-notify\x3d"url"\x3e\x3c/a\x3e\x3c/div\x3e'},
notifyGrowl:function(a){if(a){var c=new moqui.NotifySettings(a.type);!0===a.alertNoAutoHide&&(c.delay=0);$.notify(new moqui.NotifyOptions(a.title,a.link,a.type,a.icon),c);moqui.webrootVue&&moqui.webrootVue.addNotify(a.title,a.type)}},NotificationClient:function(a){this.displayEnable=!0;this.webSocketUrl=a;this.topicListeners={};this.disableDisplay=function(){this.displayEnable=!1};this.enableDisplay=function(){this.displayEnable=!0};this.initWebSocket=function(){this.webSocket=new WebSocket(this.webSocketUrl);
this.webSocket.clientObj=this;this.webSocket.onopen=function(a){this.clientObj.tryReopenCount=0;a=[];for(var b in this.clientObj.topicListeners)a.push(b);this.send("subscribe:"+a.join(","))};this.webSocket.onmessage=function(a){var b=JSON.parse(a.data);(a=this.clientObj.topicListeners[b.topic])&&a.forEach(function(a){a(b,this)},this);(a=this.clientObj.topicListeners.ALL)&&a.forEach(function(a){a(b,this)},this)};this.webSocket.onclose=function(a){console.log(a);setTimeout(this.clientObj.tryReopen,
...
this.registerListener=function(a,b){this.webSocket||this.initWebSocket();b||(b=this.displayNotify);var d=this.topicListeners[a];d||(d=[],this.topicListeners[a]=d,this.webSocket.readyState===WebSocket.OPEN&&this.webSocket.send("subscribe:"+a));0>d.indexOf(b)&&d.push(b)}},LruMap:function(a){this.limit=a;this.valueMap={};this.lruList=[];this.put=function(a,b){var d=this.lruList,e=this.valueMap;e[a]=b;for(this._keyUsed(a);d.length>this.limit;){var f=d.pop();e[f]=null}};this.get=function(a){var b=this.valueMap[a];
b&&this._keyUsed(a);return b};this.containsKey=function(a){return!!this.valueMap[a]};this._keyUsed=function(a){for(var b=this.lruList,d=-1,e=0;e<b.length;e++)if(b[e]===a){d=e;break}0<=d&&b.splice(d,1);b.unshift(a)}}};
